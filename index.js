            ...
            <div class="inline-drawer">
                ...
                <div class="inline-drawer-content">
                    ...
                    <div class="expression_avatar_note">
                        <p><i>참고: 이 확장은 SillyTavern의 expressions 확장과 연동하여 동작합니다. expressions 확장의 표정 감지 결과를 아바타에 적용합니다.</i></p>
                    </div>
                </div>
            </div>
        </div>
...
function initSettingsUI() {
    ...
    // 드로어 토글 이벤트
    $('.expression_avatar_settings .inline-drawer-toggle').on('click', function() {
